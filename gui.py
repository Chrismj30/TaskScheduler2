...
class BackupAppGUI:
    ...
    def create_home_widgets(self):
        ...
        # Home Widgets
        backup_button = tk.Button(self.home_frame, text="Backup", font=("Helvetica", 14), bg="#3498DB", fg="white", command=lambda: self.show_frame(self.backup_frame))
        backup_button.pack(pady=10)

        maintenance_button = tk.Button(self.home_frame, text="Maintenance", font=("Helvetica", 14), bg="#3498DB", fg="white", command=lambda: self.show_frame(self.maintenance_frame))
        maintenance_button.pack(pady=10)

        open_app_button = tk.Button(self.home_frame, text="Open Application", font=("Helvetica", 14), bg="#3498DB", fg="white", command=lambda: self.show_frame(self.open_app_frame))
